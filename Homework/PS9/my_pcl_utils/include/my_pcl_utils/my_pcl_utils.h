...
// 
    ...
    /* added in ps9 by Peng */
    void graspPointsByColor(PointCloud<pcl::PointXYZRGB>::Ptr inputCloud, PointCloud<pcl::PointXYZRGB>::Ptr outputCloud, Eigen::Vector3i color);
    void graspPointsBySpace(PointCloud<pcl::PointXYZRGB>::Ptr inputCloud, PointCloud<pcl::PointXYZRGB>::Ptr outputCloud);
    void graspPointsBySpace(PointCloud<pcl::PointXYZRGB>::Ptr inputCloud, PointCloud<pcl::PointXYZRGB>::Ptr outputCloud,
            Eigen::Vector3f lower_limit, Eigen::Vector3f upper_limit);
    void detectStool(PointCloud<pcl::PointXYZRGB>::Ptr inputCloud, PointCloud<pcl::PointXYZRGB>::Ptr outputCloud);
    void detectCan(PointCloud<pcl::PointXYZRGB>::Ptr inputCloud, PointCloud<pcl::PointXYZRGB>::Ptr outputCloud);
    void downgradeCloud(PointCloud<pcl::PointXYZRGB>::Ptr inputCloud, PointCloud<pcl::PointXYZ>::Ptr outputCloud);
...
private:
    ...
    /* added in ps9 by Peng */
    double compareColor(Eigen::Vector3i color1, Eigen::Vector3i color2); 
    bool isWithinLimit(Eigen::Vector3f toCompute, Eigen::Vector3f lower_limit, Eigen::Vector3f upper_limit);
    bool isNan(double f);
    bool isNanVector3f(Eigen::Vector3f f);
